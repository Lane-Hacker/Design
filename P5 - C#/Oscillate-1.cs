...
namespace Project5
{
    public class OscillateA : arithS, IArithSInterface
    {
        private bool positive = true;
        public OscillateA(uint a = 0, uint d = DEFAULT_COMMON_DIFFERENCE, uint treshold = DEFAULT_TRESHOLD, int[] inject = null) : base(a, d, treshold, inject) { }
